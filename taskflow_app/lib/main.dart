      ...
      child: Consumer<ThemeController>(
        ...
        darkTheme: ThemeData(
          colorScheme: ColorScheme.fromSeed(
            ...
            primary: const Color(0xFFFBBF24), // AMBER vibrante para destaque
            primaryContainer: const Color(0xFFF59E0B), // Amber mais escuro
            ...
            surfaceContainerHighest: const Color(0xFF334155), // Diálogos e cards
            onSurface: const Color(0xFFF1F5F9), // Texto claro com melhor contraste
            onSurfaceVariant: const Color(0xFFCBD5E1), // Texto secundário
            outline: const Color(0xFF475569), // Bordas sutis
          ),
          useMaterial3: true,
          dialogTheme: const DialogThemeData(
            backgroundColor: Color(0xFF334155), // Fundo dos diálogos mais claro
          ...
          timePickerTheme: TimePickerThemeData(
            ...
            hourMinuteColor: const Color(0xFFFBBF24), // Amber para números selecionados (substitui azul)
            hourMinuteTextColor: const Color(0xFF000000), // Texto preto no amber para contraste
            dialHandColor: const Color(0xFFFBBF24), // Ponteiro amber (substitui azul)
            dialBackgroundColor: const Color(0xFF1E293B),
            dialTextColor: Colors.white, // Números do relógio BRANCOS (não selecionados)
          ...
          textButtonTheme: TextButtonThemeData(
            style: TextButton.styleFrom(
              foregroundColor: const Color(0xFFFBBF24), // Botões de texto em amber
            ),
          ),
          elevatedButtonTheme: ElevatedButtonThemeData(
            style: ElevatedButton.styleFrom(
              backgroundColor: const Color(0xFFFBBF24), // Botões elevados em amber
          ...
          inputDecorationTheme: InputDecorationTheme(
            focusedBorder: OutlineInputBorder(
              borderSide: const BorderSide(color: Color(0xFFFBBF24), width: 2), // Borda amber ao focar
              borderRadius: BorderRadius.circular(12),
            ),
            enabledBorder: OutlineInputBorder(
              borderSide: const BorderSide(color: Color(0xFF475569)), // Borda cinza normal
              borderRadius: BorderRadius.circular(12),
            ),
            labelStyle: const TextStyle(color: Color(0xFFCBD5E1)), // Labels em cinza claro
            hintStyle: const TextStyle(color: Color(0xFF94A3B8)), // Hints em cinza médio
            prefixIconColor: const Color(0xFFFBBF24), // Ícones dos campos em amber
          ...
          appBarTheme: const AppBarTheme(
            ...
            foregroundColor: Colors.white,
            elevation: 2,
            iconTheme: IconThemeData(color: Colors.white), // Ícones brancos (menu, etc)
            actionsIconTheme: IconThemeData(color: Colors.white), // Avatar e ações brancos
          ),
          tabBarTheme: const TabBarThemeData(
            labelColor: Color(0xFFFBBF24), // Abas selecionadas em amber (substitui azul)
            unselectedLabelColor: Colors.white70, // Abas não selecionadas brancas
            indicatorColor: Color(0xFFFBBF24), // Indicador amber (substitui azul)
            indicatorSize: TabBarIndicatorSize.tab,
            labelStyle: TextStyle(
              fontWeight: FontWeight.w600,
              fontSize: 14,
          ...
          floatingActionButtonTheme: const FloatingActionButtonThemeData(
            backgroundColor: Color(0xFFFBBF24), // Amber vibrante (substitui azul)
            foregroundColor: Color(0xFF000000), // Ícone preto para contraste
          ),
          bottomNavigationBarTheme: const BottomNavigationBarThemeData(
            backgroundColor: Color(0xFF1E293B),
            selectedItemColor: Color(0xFFFBBF24), // Item selecionado em amber (substitui azul)
            unselectedItemColor: Colors.white70, // Itens não selecionados brancos
