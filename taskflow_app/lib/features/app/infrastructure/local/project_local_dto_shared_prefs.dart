...
class ProjectLocalDtoSharedPrefs implements ProjectLocalDto {
    ...
    try {
      ...
      if (raw != null && raw.isNotEmpty) {
        try {
          ...
          print('⚠️ Dados corrompidos no cache de projetos, reiniciando: $e');
        }
      }
  ...
  @override
  Future<List<ProjectDto>> listAll() async {
    try {
      final prefs = await _prefs;
      final raw = prefs.getString(_cacheKey);
  ...
  Future<void> clear() async {
    try {
      ...
      print('🗑️ Cache de projetos limpo');
    } catch (e) {
      print('❌ Erro ao limpar cache de projetos: $e');
      rethrow;
    }
  }
}
